...
def attack(char_name: str, char_class: str) -> str:
    """Генерирует количество очков атаки в зависимости от персонажа."""
    ...
    return f'{char_name} не нанёс урона противнику'


def defence(char_name: str, char_class: str) -> str:
    """Генерирует количество очков блокировки в зависимости от персонажа."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Генерирует очки специальной атаки в зависимости от персонажа."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Запускает цикл тренировки навыков выбранного персонажа."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """
    Позволяет игроку выбрать тип персонажа.
    И возвращает выбранного персонажа.
    """
